...
int caliPin = 13;               // Set Calibration Pin
int leftPin = 7;               // Set Left Mouse Pin
int rightPin = A1;              // Set Right Mouse Pin
int middlePin = A0;             // Set Middle Mouse Pin
int pedalPin = 5;                // Set pedal Pin
...
void pedalButtons() {    // Setup Cali, Left, Right & Middle Mouse buttons
